      ...
      <div className="container mx-auto px-4 md:px-6 max-w-7xl relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          <div className="lg:col-span-2">
            <h2 className="text-2xl font-bold text-white mb-6">Thor Signia</h2>
            ...
            <ul className="space-y-3">
              <li className="transition-transform hover:translate-x-1">
                <Link to="/" className="text-gray-300 hover:text-white transition-colors flex items-center">
                  <ArrowRight className="w-4 h-4 mr-2 text-[#009898] opacity-0 group-hover:opacity-100 transition-opacity" />
                  Home
                </Link>
              </li>
              <li className="transition-transform hover:translate-x-1">
